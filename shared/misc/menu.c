...
{
	Draw_Character (cx + (vid.width/2) - 180, line + (vid.height/2) - 90, num);
}
...
{
	Draw_TransPic (x + (vid.width/2) - 180, y + (vid.height/2) - 90, pic);
}

void M_DrawPic (int x, int y, qpic_t *pic)
{
	Draw_Pic (x + (vid.width/2) - 180, y + (vid.height/2) - 90, pic);
}
...
{
	Draw_TransPicTranslate (x + (vid.width/2) - 180, y + (vid.height/2) - 90, pic, translationTable);
}
